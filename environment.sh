...
mkdir -p "$(dirname "${GRASP_MODEL_PATH}")"
...
#   --local-dir "${GRASP_MODEL_ROOT}/InternViT-300M-448px-V2_5" \
#   --local-dir-use-symlinks False
# huggingface-cli download Qwen/Qwen2.5-0.5B-Instruct \
#   --local-dir "${GRASP_MODEL_ROOT}/Qwen2.5-0.5B-Instruct" \
#   --local-dir-use-symlinks False
