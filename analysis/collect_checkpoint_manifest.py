...
def infer(path: Path) -> dict[str, str]:
    ...
    return {
        ...
        "bbox_ratio": csv_value(config.get("bbox_ratio", "")) if evaluation_mode == "predicted_vcot" else "",
        "grasp_loss_weight": csv_value(config.get("grasp_loss_weight", "")) if evaluation_mode == "predicted_vcot" else "",
        "bbox_loss_weight": csv_value(config.get("bbox_loss_weight", "")) if evaluation_mode == "predicted_vcot" else "",
