...
EXPERIMENT="${EXPERIMENT:-baseline_full_lora16_lr8e-5_ep1_patch6_edge15_half50}"
CHECKPOINT="${CHECKPOINT:-artifacts/runs/crop/${EXPERIMENT}/checkpoint-1}"
DATASETS="${DATASETS:-test_seen,test_unseen}"
OUT_DIR="${OUT_DIR:-artifacts/results/crop/${EXPERIMENT}}"
VCOT_IOU_THRESHOLD="${VCOT_IOU_THRESHOLD:-0.25}"
VCOT_ANGLE_THRESHOLD="${VCOT_ANGLE_THRESHOLD:-30.0}"

"${PYTHON_BIN:-python}" eval/evaluate_crop_grasp.py \
