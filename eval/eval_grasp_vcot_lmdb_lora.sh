...
GPUS="${GPUS:-1}"
WORK_DIR="${WORK_DIR:-${GP_ROOT}/InternVL/internvl_chat/work_dirs/internvl_chat_v2_5/grasp_vcot_hparams/vcot_lora16_lr8e-5_ep1_patch6_bbox0.5}"
...
OUT_DIR="${OUT_DIR:-${GP_ROOT}/result/vcot_grasp_vcot}"
